...
devtools::install_github("paleolimbot/pb210")
...
alta_lake_drying <- readxl::read_excel("~/Downloads/alta_lake_pb210.xlsx", sheet = "drying")
alta_lake_210Pb_raw <- readxl::read_excel("~/Downloads/alta_lake_pb210.xlsx", sheet = "pb210")
